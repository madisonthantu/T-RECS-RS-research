...
def run_xquad(
    ...
    xquad = xQuAD(
        ...
        xquad_method=xquad_method,
        alpha=xquad_alpha,
        **model_config
    )
    xquad.add_metrics(*metrics_list)
    xquad.startup_and_train(**train_config)
    xquad.run(**run_config)
...
def create_output_string(args):
    ...
    # parser.add_argument('--repeated_items', type=int,  default=False)
...
"""
DONE:
[1][a]      xQuAD smooth, single training
            python run_xquad_experiments.py  --output_dir sim_results  --model_name xquad_smooth  --repeated_training 0  --startup_iters 50  --sim_iters 50  --num_sims 5  --probabilistic 0
[1][b]      xQuAD smooth, repeated training
            python run_xquad_experiments.py  --output_dir sim_results  --model_name xquad_smooth  --repeated_training 1  --startup_iters 10  --sim_iters 90  --num_sims 5  --probabilistic 0

TO DO:
[2][a]      xQuAD binary, single training
            python run_xquad_experiments.py  --output_dir sim_results  --model_name xquad_binary  --repeated_training 0  --startup_iters 50  --sim_iters 50  --num_sims 5  --probabilistic 0
[2][b]      xQuAD binary, single training
            python run_xquad_experiments.py  --output_dir sim_results  --model_name xquad_binary  --repeated_training 1  --startup_iters 10  --sim_iters 90  --num_sims 5  --probabilistic 0
"""
if __name__ == "__main__":
    ...
    with open(os.path.join(output_directory, "args.txt"), "w") as log_file:
        ...
        pprint.pprint(xquad_models, log_file)
    ...
    for model_name in xquad_models:
        xquad_method = xquad_models[model_name][0]
        xquad_alpha = xquad_models[model_name][1] 
